...
class BookingTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        mainBackGroundView.layer.borderColor = UIColor(red: 0/255, green: 128/255, blue: 223/255, alpha: 0.3).cgColor
        mainBackGroundView.layer.masksToBounds = true
        mainBackGroundView.layer.cornerRadius = 8
        minusBtnOutlet.layer.borderWidth = 1
        minusBtnOutlet.layer.borderColor = UIColor.black.cgColor
        plusBtnOutlet.layer.borderWidth = 1
        plusBtnOutlet.layer.borderColor = UIColor.black.cgColor
        ...
        morningBtnOutlet.layer.borderColor = UIColor(red: 0/255, green: 128/255, blue: 223/255, alpha: 0.7).cgColor
        afterNoonBtnoutlet.layer.borderColor = UIColor(red: 0/255, green: 128/255, blue: 223/255, alpha: 0.7).cgColor
    ...
    @IBAction func morningBtnAction(_ sender: Any) {
        dayTimeIs = "Morning"
        morningBtnOutlet.layer.backgroundColor = UIColor(red: 0/255, green: 128/255, blue: 223/255, alpha: 0.3).cgColor
    ...
    @IBAction func afternoonBtnAction(_ sender: Any) {
        dayTimeIs = "Afternoon"
        afterNoonBtnoutlet.layer.backgroundColor = UIColor(red: 0/255, green: 128/255, blue: 223/255, alpha: 0.3).cgColor
        morningBtnOutlet.layer.backgroundColor = UIColor(red: 255/255, green: 255/255, blue: 255/255, alpha: 0.5).cgColor
    }
    
    @IBAction func confirmBtnAction(_ sender: Any) {
        
        if phoneNumberTxtFld.text != "" && addressTxtView.text != ""{
            print(itemCount)
            print(dayTimeIs)
            print(currentDate)
